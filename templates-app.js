...
angular.module("home/home.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("home/home.tpl.html",
    "<div class=\"row\">\n" +
    "    <div class=\"col-md-12\">\n" +
    "        <h3 class=\"head text-center\">AngularJs + Deezer = NgDeezer</span></h3>\n" +
    "        <p class=\"narrow text-center\">\n" +
    "            Easy integration of DeezerSdk into AngularJs project\n" +
    "        </p>\n" +
    "        <p class=\"text-center\">\n" +
    "            <iframe src=\"http://ghbtns.com/github-btn.html?user=gianarb&repo=ng-deezer-sdk&type=follow\"\n" +
    "                  allowtransparency=\"true\" frameborder=\"0\" scrolling=\"0\" width=\"120\" height=\"20\"></iframe>\n" +
    "            <iframe src=\"http://ghbtns.com/github-btn.html?user=gianarb&repo=ng-deezer-sdk&type=fork\"\n" +
    "                  allowtransparency=\"true\" frameborder=\"0\" scrolling=\"0\" width=\"120\" height=\"20\" count=\"true\"></iframe>\n" +
    "            <iframe src=\"http://ghbtns.com/github-btn.html?user=gianarb&repo=ng-deezer-sdk&type=watch\"\n" +
    "                  allowtransparency=\"true\" frameborder=\"0\" scrolling=\"0\" width=\"120\" count=\"true\" height=\"20\"></iframe>\n" +
    "        </p>\n" +
    "\n" +
    "        <p class=\"text-center\">\n" +
    "            <a href=\"\" class=\"btn btn-success btn-outline-rounded green\">Github<span style=\"margin-left:10px;\"</span><i class=\"fa fa-github-alt\"></i></a>\n" +
    "        </p>\n" +
    "    </div>\n" +
    "</div>\n" +
    "\n" +
    ...
    "<div class=\"row album\">\n" +
    "    <div class=\"col-md-12\">\n" +
    "        <h3 ng-model=\"album.title\">{{album.title}}</h3>\n" +
    "    </div>\n" +
    "</div>\n" +
    "\n" +
    "<div class=\"row album\">\n" +
    "    <div class=\"col-md-7\">\n" +
    "        <ul>\n" +
    "            <li ng-repeat=\"track in album.tracks.data\">{{track.title}}</li>\n" +
    "        <ul>\n" +
    "    </div>\n" +
    "    <div class=\"col-md-5\">\n" +
    "        <div class=\"row\">\n" +
    ...
    "       <div class=\"row\">\n" +
    "            <div class=\"col-md-12\">\n" +
    "                <button ng-click=\"play()\" class=\"btn\">Play!</button>\n" +
    "            </div>\n" +
    "       </div>\n" +
    "\n" +
    "    </div>\n" +
